...
const skyMaterial = new THREE.MeshBasicMaterial({
  ...
  side: THREE.BackSide // Make sure the texture is visible from inside the sphere
});
const skyMesh = new THREE.Mesh(skyGeometry, skyMaterial);
scene.add(skyMesh);
skyMesh.userData.planetName = 'Stars'
skyMesh.userData.planetInfo = 'A star is a luminous ball of gas that emits energy, including light and heat, through nuclear fusion reactions in its core.'
//Sun
